...
MCP (Model Context Protocol) сервер для **Yandex Direct** и **Yandex Metrika** API. Предоставляет **120 инструментов** для управления рекламными кампаниями, аналитикой и отчётностью через любой MCP-совместимый клиент.

> Управляй рекламой и аналитикой Яндекса через AI

## Возможности

### Yandex Direct API v5 (77 инструментов)
...
- **Статистика** — детальные отчёты по эффективности
...
├── client.py            # Async HTTP-клиент для Direct и Metrika API
...
└── tools/               # Определения MCP-инструментов
    ├── direct/          # 77 инструментов Yandex Direct
